...
# It determines if the library will use database transactions on data import, just to be on the safe side.
...
SWAGGER_SETTINGS = {
    "DEFAULT_AUTO_SCHEMA_CLASS": "omsk.schemas.CustomAutoSchema"
}